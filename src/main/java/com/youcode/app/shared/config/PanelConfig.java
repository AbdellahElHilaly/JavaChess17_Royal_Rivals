...
public class PanelConfig {
    ...
    public static class Cell {
        ...
        public static final Border CLICKED_PIECE_BORDER = BorderFactory.createLineBorder(AppColors.CLICKED, 3);
        public static final Border CLICKED_EMPTY_BORDER = BorderFactory.createLineBorder(AppColors.BORDER, 3);
        public static final Border INVALID_MOVE_BORDER = BorderFactory.createLineBorder(AppColors.ERROR, 4);
        public static final Border VALID_MOVE_BORDER = BorderFactory.createLineBorder(AppColors.SUCCESS, 4);

        public static final Border CHECK_BORDER= BorderFactory.createMatteBorder(0, 0, 5, 0, AppColors.CHECK);
        public static final Border CHECK_MATE_BORDER= BorderFactory.createMatteBorder(0, 0, 5, 0, AppColors.CHECK_MATE);
